...
void testEqualStrings(void)
{
    ...
    TEST_ASSERT__EQUAL__STRING(testString, testString);
    TEST_ASSERT__EQUAL__STRING_MESSAGE("foo", "foo", "foo isn't foo");
    TEST_ASSERT__EQUAL__STRING("foo", testString);
    TEST_ASSERT__EQUAL__STRING(testString, "foo");
    TEST_ASSERT__EQUAL__STRING("", "");
}

void testEqualStringsLen(void)
{
    const char *testString = "foobar";
    TEST_ASSERT__EQUAL__STRING_LEN(testString, testString, strlen(testString));
    TEST_ASSERT__EQUAL__STRING_LEN_MESSAGE("foobar", "foobaz", 5, "fooba isn't fooba");
    TEST_ASSERT__EQUAL__STRING_LEN("foo", testString, 3);
    TEST_ASSERT__EQUAL__STRING_LEN(testString, "foo", 3);
    TEST_ASSERT__EQUAL__STRING_LEN("", "", 3);
}
...
void testEqualStringsWithCarriageReturnsAndLineFeeds(void)
{
    ...
    TEST_ASSERT__EQUAL__STRING(testString, testString);
    TEST_ASSERT__EQUAL__STRING("foo\r\nbar", "foo\r\nbar");
    TEST_ASSERT__EQUAL__STRING("foo\r\nbar", testString);
    TEST_ASSERT__EQUAL__STRING(testString, "foo\r\nbar");
    TEST_ASSERT__EQUAL__STRING("", "");
}
...
{
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__EQUAL__STRING("foo", "bar");
    VERIFY_FAILS_END
}
...
{
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__EQUAL__STRING_LEN("foobar", "foobaz", 6);
    VERIFY_FAILS_END
}
...
{
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__EQUAL__STRING_LEN("foo", "", 3);
    VERIFY_FAILS_END
}
...
{
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__EQUAL__STRING("", "bar");
    VERIFY_FAILS_END
}
...
{
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__EQUAL__STRING_LEN("", "bar", 3);
    VERIFY_FAILS_END
}
...
{
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__EQUAL__STRING("bar\r", "bar\n");
    VERIFY_FAILS_END
}
...
{
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__EQUAL__STRING_LEN("ba\r\x16", "ba\r\n", 4);
    VERIFY_FAILS_END
}
...
void testNotEqualString5(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__EQUAL__STRING(str1, str2);
    VERIFY_FAILS_END
}
...
{
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__EQUAL__STRING(NULL, "bar");
    VERIFY_FAILS_END
}
...
{
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__EQUAL__STRING_LEN(NULL, "bar", 1);
    VERIFY_FAILS_END
}
...
{
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__EQUAL__STRING("foo", NULL);
    VERIFY_FAILS_END
}
...
{
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__EQUAL__STRING_LEN("foo", NULL, 1);
    VERIFY_FAILS_END
}
...
{
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__EQUAL__STRING("foo2", "foo");
    VERIFY_FAILS_END
}
...
{
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__EQUAL__STRING("foo", "foo2");
    VERIFY_FAILS_END
}
...
void testEqualStringArrays(void)
{
    ...
    TEST_ASSERT__EQUAL_ARRAY__STRING(expStrings, expStrings, 3);
    TEST_ASSERT__EQUAL_ARRAY__STRING(expStrings, testStrings, 3);
    TEST_ASSERT__EQUAL_ARRAY__STRING(expStrings, testStrings, 2);
    TEST_ASSERT__EQUAL_ARRAY__STRING(expStrings, testStrings, 1);
}
...
void testNotEqualStringArray1(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__EQUAL_ARRAY__STRING(expStrings, testStrings, 4);
    VERIFY_FAILS_END
}
...
void testNotEqualStringArrayLengthZero(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__EQUAL_ARRAY__STRING(expStrings, testStrings, 0);
    VERIFY_FAILS_END
}
...
void testEqualStringEachEqual(void)
{
    ...
    TEST_ASSERT__EQUAL_EACH__STRING("foo", testStrings1, 4);
    TEST_ASSERT__EQUAL_EACH__STRING("foo", testStrings1, 1);
    TEST_ASSERT__EQUAL_EACH__STRING("boo", testStrings2, 3);
    TEST_ASSERT__EQUAL_EACH__STRING("", testStrings3, 4);
}
...
void testNotEqualStringEachEqual1(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__EQUAL_EACH__STRING("foo", testStrings, 4);
    VERIFY_FAILS_END
}
...
{
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__EQUAL_EACH__STRING("foo", NULL, 1);
    VERIFY_FAILS_END
}
...
void testCstringsEscapeSequence(void)
{
    ...
    UnityPrint("\x16\x10");
    endPutcharSpy();
    TEST_ASSERT__EQUAL__STRING("\\x16\\x10", getBufferPutcharSpy());
#endif
}
