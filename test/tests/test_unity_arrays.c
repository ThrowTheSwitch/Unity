...
void testIntArrayWithinDelta(void)
{
    ...
    TEST_ASSERT__WITHIN_ARRAY__INT(1, expected, actualSmallDelta, 3);
    TEST_ASSERT__WITHIN_ARRAY__INT(110, expected, actualBigDelta, 3);
}
...
void testIntArrayWithinDeltaAndMessage(void)
{
    ...
    TEST_ASSERT__WITHIN_ARRAY__INT_MESSAGE(1, expected, actualSmallDelta, 3, "Custom Message.");
    TEST_ASSERT__WITHIN_ARRAY__INT_MESSAGE(110, expected, actualBigDelta, 3, "Custom Message.");
}
...
void testIntArrayNotWithinDelta(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__INT(1, expected, actualBigDelta, 3);
    VERIFY_FAILS_END
}
...
void testIntArrayNotWithinDeltaAndMessage(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__INT_MESSAGE(1, expected, actualBigDelta, 3, "Custom Message.");
    VERIFY_FAILS_END
}
...
void testIntArrayWithinDeltaPointless(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__INT(110, expected, actualBigDelta, 0);
    VERIFY_FAILS_END
}
...
void testIntArrayWithinDeltaPointlessAndMessage(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__INT_MESSAGE(110, expected, actualBigDelta, 0, "Custom Message.");
    VERIFY_FAILS_END
}
...
void testIntArrayWithinDeltaExpectedNull(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__INT(110, NULL, actualBigDelta, 3);
    VERIFY_FAILS_END
}
...
void testIntArrayWithinDeltaExpectedNullAndMessage(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__INT_MESSAGE(110, NULL, actualBigDelta, 3, "Custom Message.");
    VERIFY_FAILS_END
}
...
void testIntArrayWithinDeltaActualNull(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__INT(110, expected, NULL, 3);
    VERIFY_FAILS_END
}
...
void testIntArrayWithinDeltaActualNullAndMessage(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__INT_MESSAGE(110, expected, NULL, 3, "Custom Message.");
    VERIFY_FAILS_END
}
...
void testIntArrayWithinDeltaSamePointer(void)
{
    ...
    TEST_ASSERT__WITHIN_ARRAY__INT(110, expected, expected, 3);
}
...
void testIntArrayWithinDeltaSamePointerAndMessage(void)
{
    ...
    TEST_ASSERT__WITHIN_ARRAY__INT_MESSAGE(110, expected, expected, 3, "Custom Message.");
}
...
void testInt16ArrayWithinDelta(void)
{
    ...
    TEST_ASSERT__WITHIN_ARRAY__INT16(1, expected, actualSmallDelta, 3);
    TEST_ASSERT__WITHIN_ARRAY__INT16(110, expected, actualBigDelta, 3);
}
...
void testInt16ArrayWithinDeltaAndMessage(void)
{
    ...
    TEST_ASSERT__WITHIN_ARRAY__INT16_MESSAGE(1, expected, actualSmallDelta, 3, "Custom Message.");
    TEST_ASSERT__WITHIN_ARRAY__INT16_MESSAGE(110, expected, actualBigDelta, 3, "Custom Message.");
}
...
void testInt16ArrayNotWithinDelta(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__UINT16(1, expected, actualBigDelta, 3);
    VERIFY_FAILS_END
}
...
void testInt16ArrayNotWithinDeltaAndMessage(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__INT16_MESSAGE(1, expected, actualBigDelta, 3, "Custom Message.");
    VERIFY_FAILS_END
}
...
void testInt16ArrayWithinDeltaPointless(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__INT16(110, expected, actualBigDelta, 0);
    VERIFY_FAILS_END
}
...
void testInt16ArrayWithinDeltaPointlessAndMessage(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__INT16_MESSAGE(110, expected, actualBigDelta, 0, "Custom Message.");
    VERIFY_FAILS_END
}
...
void testInt16ArrayWithinDeltaExpectedNull(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__INT16(110, NULL, actualBigDelta, 3);
    VERIFY_FAILS_END
}
...
void testInt16ArrayWithinDeltaExpectedNullAndMessage(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__INT16_MESSAGE(110, NULL, actualBigDelta, 3, "Custom Message.");
    VERIFY_FAILS_END
}
...
void testInt16ArrayWithinDeltaActualNull(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__INT16(110, expected, NULL, 3);
    VERIFY_FAILS_END
}
...
void testInt16ArrayWithinDeltaActualNullAndMessage(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__INT16_MESSAGE(110, expected, NULL, 3, "Custom Message.");
    VERIFY_FAILS_END
}
...
void testInt16ArrayWithinDeltaSamePointer(void)
{
    ...
    TEST_ASSERT__WITHIN_ARRAY__INT16(110, expected, expected, 3);
}
...
void testInt16ArrayWithinDeltaSamePointerAndMessage(void)
{
    ...
    TEST_ASSERT__WITHIN_ARRAY__INT16_MESSAGE(110, expected, expected, 3, "Custom Message.");
}
...
void testInt8ArrayWithinDelta(void)
{
    ...
    TEST_ASSERT__WITHIN_ARRAY__INT8(1, expected, actualSmallDelta, 3);
    TEST_ASSERT__WITHIN_ARRAY__INT8(11, expected, actualBigDelta, 3);
}
...
void testInt8ArrayWithinDeltaAndMessage(void)
{
    ...
    TEST_ASSERT__WITHIN_ARRAY__INT8_MESSAGE(1, expected, actualSmallDelta, 3, "Custom Message.");
    TEST_ASSERT__WITHIN_ARRAY__INT8_MESSAGE(11, expected, actualBigDelta, 3, "Custom Message.");
}
...
void testInt8ArrayNotWithinDelta(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__INT8(1, expected, actualBigDelta, 3);
    VERIFY_FAILS_END
}
...
void testInt8ArrayNotWithinDeltaAndMessage(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__INT8_MESSAGE(1, expected, actualBigDelta, 3, "Custom Message.");
    VERIFY_FAILS_END
}
...
void testInt8ArrayWithinDeltaPointless(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__INT8(11, expected, actualBigDelta, 0);
    VERIFY_FAILS_END
}
...
void testInt8ArrayWithinDeltaPointlessAndMessage(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__INT8_MESSAGE(11, expected, actualBigDelta, 0, "Custom Message.");
    VERIFY_FAILS_END
}
...
void testInt8ArrayWithinDeltaExpectedNull(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__INT8(11, NULL, actualBigDelta, 3);
    VERIFY_FAILS_END
}
...
void testInt8ArrayWithinDeltaExpectedNullAndMessage(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__INT8_MESSAGE(11, NULL, actualBigDelta, 3, "Custom Message.");
    VERIFY_FAILS_END
}
...
void testInt8ArrayWithinDeltaActualNull(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__INT8(11, expected, NULL, 3);
    VERIFY_FAILS_END
}
...
void testInt8ArrayWithinDeltaActualNullAndMessage(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__INT8_MESSAGE(11, expected, NULL, 3, "Custom Message.");
    VERIFY_FAILS_END
}
...
void testInt8ArrayWithinDeltaSamePointer(void)
{
    ...
    TEST_ASSERT__WITHIN_ARRAY__INT8(11, expected, expected, 3);
}
...
void testInt8ArrayWithinDeltaSamePointerAndMessage(void)
{
    ...
    TEST_ASSERT__WITHIN_ARRAY__INT8_MESSAGE(11, expected, expected, 3, "Custom Message.");
}
...
void testCHARArrayWithinDelta(void)
{
    ...
    TEST_ASSERT__WITHIN_ARRAY__CHAR(1, expected, actualSmallDelta, 3);
    TEST_ASSERT__WITHIN_ARRAY__CHAR(11, expected, actualBigDelta, 3);
}
...
void testCHARArrayWithinDeltaAndMessage(void)
{
    ...
    TEST_ASSERT__WITHIN_ARRAY__CHAR_MESSAGE(1, expected, actualSmallDelta, 3, "Custom Message.");
    TEST_ASSERT__WITHIN_ARRAY__CHAR_MESSAGE(11, expected, actualBigDelta, 3, "Custom Message.");
}
...
void testCHARArrayNotWithinDelta(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__CHAR(1, expected, actualBigDelta, 3);
    VERIFY_FAILS_END
}
...
void testCHARArrayNotWithinDeltaAndMessage(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__CHAR_MESSAGE(1, expected, actualBigDelta, 3, "Custom Message.");
    VERIFY_FAILS_END
}
...
void testCHARArrayWithinDeltaPointless(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__CHAR(11, expected, actualBigDelta, 0);
    VERIFY_FAILS_END
}
...
void testCHARArrayWithinDeltaPointlessAndMessage(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__CHAR_MESSAGE(11, expected, actualBigDelta, 0, "Custom Message.");
    VERIFY_FAILS_END
}
...
void testCHARArrayWithinDeltaExpectedNull(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__CHAR(11, NULL, actualBigDelta, 3);
    VERIFY_FAILS_END
}
...
void testCHARArrayWithinDeltaExpectedNullAndMessage(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__CHAR_MESSAGE(11, NULL, actualBigDelta, 3, "Custom Message.");
    VERIFY_FAILS_END
}
...
void testCHARArrayWithinDeltaActualNull(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__CHAR(11, expected, NULL, 3);
    VERIFY_FAILS_END
}
...
void testCHARArrayWithinDeltaActualNullAndMessage(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__CHAR_MESSAGE(11, expected, NULL, 3, "Custom Message.");
    VERIFY_FAILS_END
}
...
void testCHARArrayWithinDeltaSamePointer(void)
{
    ...
    TEST_ASSERT__WITHIN_ARRAY__CHAR(11, expected, expected, 3);
}
...
void testCHARArrayWithinDeltaSamePointerAndMessage(void)
{
    ...
    TEST_ASSERT__WITHIN_ARRAY__CHAR_MESSAGE(11, expected, expected, 3, "Custom Message.");
}
...
void testUIntArrayWithinDelta(void)
{
    ...
    TEST_ASSERT__WITHIN_ARRAY__UINT(1, expected, actualSmallDelta, 3);
    TEST_ASSERT__WITHIN_ARRAY__UINT(110, expected, actualBigDelta, 3);
}
...
void testUIntArrayWithinDeltaAndMessage(void)
{
    ...
    TEST_ASSERT__WITHIN_ARRAY__UINT_MESSAGE(1, expected, actualSmallDelta, 3, "Custom Message.");
    TEST_ASSERT__WITHIN_ARRAY__UINT_MESSAGE(110, expected, actualBigDelta, 3, "Custom Message.");
}
...
void testUIntArrayNotWithinDelta(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__UINT(1, expected, actualBigDelta, 3);
    VERIFY_FAILS_END
}
...
void testUIntArrayNotWithinDeltaAndMessage(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__UINT_MESSAGE(1, expected, actualBigDelta, 3, "Custom Message.");
    VERIFY_FAILS_END
}
...
void testUIntArrayWithinDeltaPointless(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__UINT(110, expected, actualBigDelta, 0);
    VERIFY_FAILS_END
}
...
void testUIntArrayWithinDeltaPointlessAndMessage(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__UINT_MESSAGE(110, expected, actualBigDelta, 0, "Custom Message.");
    VERIFY_FAILS_END
}
...
void testUIntArrayWithinDeltaExpectedNull(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__UINT(110, NULL, actualBigDelta, 3);
    VERIFY_FAILS_END
}
...
void testUIntArrayWithinDeltaExpectedNullAndMessage(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__UINT_MESSAGE(110, NULL, actualBigDelta, 3, "Custom Message.");
    VERIFY_FAILS_END
}
...
void testUIntArrayWithinDeltaActualNull(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__UINT(110, expected, NULL, 3);
    VERIFY_FAILS_END
}
...
void testUIntArrayWithinDeltaActualNullAndMessage(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__UINT_MESSAGE(110, expected, NULL, 3, "Custom Message.");
    VERIFY_FAILS_END
}
...
void testUIntArrayWithinDeltaSamePointer(void)
{
    ...
    TEST_ASSERT__WITHIN_ARRAY__UINT(110, expected, expected, 3);
}
...
void testUIntArrayWithinDeltaSamePointerAndMessage(void)
{
    ...
    TEST_ASSERT__WITHIN_ARRAY__UINT_MESSAGE(110, expected, expected, 3, "Custom Message.");
}
...
void testUInt16ArrayWithinDelta(void)
{
    ...
    TEST_ASSERT__WITHIN_ARRAY__UINT16(1, expected, actualSmallDelta, 3);
    TEST_ASSERT__WITHIN_ARRAY__UINT16(110, expected, actualBigDelta, 3);
}
...
void testUInt16ArrayWithinDeltaAndMessage(void)
{
    ...
    TEST_ASSERT__WITHIN_ARRAY__UINT16_MESSAGE(1, expected, actualSmallDelta, 3, "Custom Message.");
    TEST_ASSERT__WITHIN_ARRAY__UINT16_MESSAGE(110, expected, actualBigDelta, 3, "Custom Message.");
}
...
void testUInt16ArrayNotWithinDeltaAndMessage(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__UINT16_MESSAGE(1, expected, actualBigDelta, 3, "Custom Message.");
    VERIFY_FAILS_END
}
...
void testUInt16ArrayWithinDeltaPointless(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__UINT16(110, expected, actualBigDelta, 0);
    VERIFY_FAILS_END
}
...
void testUInt16ArrayWithinDeltaPointlessAndMessage(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__UINT16_MESSAGE(110, expected, actualBigDelta, 0, "Custom Message.");
    VERIFY_FAILS_END
}
...
void testUInt16ArrayWithinDeltaExpectedNull(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__UINT16(110, NULL, actualBigDelta, 3);
    VERIFY_FAILS_END
}
...
void testUInt16ArrayWithinDeltaExpectedNullAndMessage(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__UINT16_MESSAGE(110, NULL, actualBigDelta, 3, "Custom Message.");
    VERIFY_FAILS_END
}
...
void testUInt16ArrayWithinDeltaActualNull(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__UINT16(110, expected, NULL, 3);
    VERIFY_FAILS_END
}
...
void testUInt16ArrayWithinDeltaActualNullAndMessage(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__UINT16_MESSAGE(110, expected, NULL, 3, "Custom Message.");
    VERIFY_FAILS_END
}
...
void testUInt16ArrayWithinDeltaSamePointer(void)
{
    ...
    TEST_ASSERT__WITHIN_ARRAY__UINT16(110, expected, expected, 3);
}
...
void testUInt16ArrayWithinDeltaSamePointerAndMessage(void)
{
    ...
    TEST_ASSERT__WITHIN_ARRAY__UINT16_MESSAGE(110, expected, expected, 3, "Custom Message.");
}
...
void testUInt8ArrayWithinDelta(void)
{
    ...
    TEST_ASSERT__WITHIN_ARRAY__UINT8(1, expected, actualSmallDelta, 3);
    TEST_ASSERT__WITHIN_ARRAY__UINT8(11, expected, actualBigDelta, 3);
}
...
void testUInt8ArrayWithinDeltaAndMessage(void)
{
    ...
    TEST_ASSERT__WITHIN_ARRAY__UINT8_MESSAGE(1, expected, actualSmallDelta, 3, "Custom Message.");
    TEST_ASSERT__WITHIN_ARRAY__UINT8_MESSAGE(11, expected, actualBigDelta, 3, "Custom Message.");
}
...
void testUInt8ArrayNotWithinDelta(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__UINT8(1, expected, actualBigDelta, 3);
    VERIFY_FAILS_END
}
...
void testUInt8ArrayNotWithinDeltaAndMessage(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__UINT8_MESSAGE(1, expected, actualBigDelta, 3, "Custom Message.");
    VERIFY_FAILS_END
}
...
void testUInt8ArrayWithinDeltaPointless(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__UINT8(11, expected, actualBigDelta, 0);
    VERIFY_FAILS_END
}
...
void testUInt8ArrayWithinDeltaPointlessAndMessage(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__UINT8_MESSAGE(11, expected, actualBigDelta, 0, "Custom Message.");
    VERIFY_FAILS_END
}
...
void testUInt8ArrayWithinDeltaExpectedNull(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__UINT8(11, NULL, actualBigDelta, 3);
    VERIFY_FAILS_END
}
...
void testUInt8ArrayWithinDeltaExpectedNullAndMessage(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__UINT8_MESSAGE(11, NULL, actualBigDelta, 3, "Custom Message.");
    VERIFY_FAILS_END
}
...
void testUInt8ArrayWithinDeltaActualNull(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__UINT8(11, expected, NULL, 3);
    VERIFY_FAILS_END
}
...
void testUInt8ArrayWithinDeltaActualNullAndMessage(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__UINT8_MESSAGE(11, expected, NULL, 3, "Custom Message.");
    VERIFY_FAILS_END
}
...
void testUInt8ArrayWithinDeltaSamePointer(void)
{
    ...
    TEST_ASSERT__WITHIN_ARRAY__UINT8(11, expected, expected, 3);
}
...
void testUInt8ArrayWithinDeltaSamePointerAndMessage(void)
{
    ...
    TEST_ASSERT__WITHIN_ARRAY__UINT8_MESSAGE(11, expected, expected, 3, "Custom Message.");
}
...
void testHEX32ArrayWithinDelta(void)
{
    ...
    TEST_ASSERT__WITHIN_ARRAY__HEX32(1, expected, actualSmallDelta, 3);
    TEST_ASSERT__WITHIN_ARRAY__HEX32(110, expected, actualBigDelta, 3);
}
...
void testHEX32ArrayWithinDeltaAndMessage(void)
{
    ...
    TEST_ASSERT__WITHIN_ARRAY__HEX32_MESSAGE(1, expected, actualSmallDelta, 3, "Custom Message.");
    TEST_ASSERT__WITHIN_ARRAY__HEX32_MESSAGE(110, expected, actualBigDelta, 3, "Custom Message.");
}
...
void testHEX32ArrayNotWithinDelta(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__HEX32(1, expected, actualBigDelta, 3);
    VERIFY_FAILS_END
}
...
void testHEX32ArrayNotWithinDeltaAndMessage(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__HEX32_MESSAGE(1, expected, actualBigDelta, 3, "Custom Message.");
    VERIFY_FAILS_END
}
...
void testHEX32ArrayWithinDeltaPointless(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__HEX32(110, expected, actualBigDelta, 0);
    VERIFY_FAILS_END
}
...
void testHEX32ArrayWithinDeltaPointlessAndMessage(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__HEX32_MESSAGE(110, expected, actualBigDelta, 0, "Custom Message.");
    VERIFY_FAILS_END
}
...
void testHEX32ArrayWithinDeltaExpectedNull(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__HEX32(110, NULL, actualBigDelta, 3);
    VERIFY_FAILS_END
}
...
void testHEX32ArrayWithinDeltaExpectedNullAndMessage(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__HEX32_MESSAGE(110, NULL, actualBigDelta, 3, "Custom Message.");
    VERIFY_FAILS_END
}
...
void testHEX32ArrayWithinDeltaActualNull(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__HEX32(110, expected, NULL, 3);
    VERIFY_FAILS_END
}
...
void testHEX32ArrayWithinDeltaActualNullAndMessage(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__HEX32_MESSAGE(110, expected, NULL, 3, "Custom Message.");
    VERIFY_FAILS_END
}
...
void testHEX32ArrayWithinDeltaSamePointer(void)
{
    ...
    TEST_ASSERT__WITHIN_ARRAY__HEX32(110, expected, expected, 3);
}
...
void testHEX32ArrayWithinDeltaSamePointerAndMessage(void)
{
    ...
    TEST_ASSERT__WITHIN_ARRAY__HEX32_MESSAGE(110, expected, expected, 3, "Custom Message.");
}
...
void testHEX16ArrayWithinDelta(void)
{
    ...
    TEST_ASSERT__WITHIN_ARRAY__HEX16(1, expected, actualSmallDelta, 3);
    TEST_ASSERT__WITHIN_ARRAY__HEX16(110, expected, actualBigDelta, 3);
}
...
void testHEX16ArrayWithinDeltaAndMessage(void)
{
    ...
    TEST_ASSERT__WITHIN_ARRAY__HEX16_MESSAGE(1, expected, actualSmallDelta, 3, "Custom Message.");
    TEST_ASSERT__WITHIN_ARRAY__HEX16_MESSAGE(110, expected, actualBigDelta, 3, "Custom Message.");
}
...
void testHEX16ArrayNotWithinDelta(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__HEX16(1, expected, actualBigDelta, 3);
    VERIFY_FAILS_END
}
...
void testHEX16ArrayNotWithinDeltaAndMessage(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__HEX16_MESSAGE(1, expected, actualBigDelta, 3, "Custom Message.");
    VERIFY_FAILS_END
}
...
void testHEX16ArrayWithinDeltaPointless(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__HEX16(110, expected, actualBigDelta, 0);
    VERIFY_FAILS_END
}
...
void testHEX16ArrayWithinDeltaPointlessAndMessage(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__HEX16_MESSAGE(110, expected, actualBigDelta, 0, "Custom Message.");
    VERIFY_FAILS_END
}
...
void testHEX16ArrayWithinDeltaExpectedNull(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__HEX16(110, NULL, actualBigDelta, 3);
    VERIFY_FAILS_END
}
...
void testHEX16ArrayWithinDeltaExpectedNullAndMessage(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__HEX16_MESSAGE(110, NULL, actualBigDelta, 3, "Custom Message.");
    VERIFY_FAILS_END
}
...
void testHEX16ArrayWithinDeltaActualNull(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__HEX16(110, expected, NULL, 3);
    VERIFY_FAILS_END
}
...
void testHEX16ArrayWithinDeltaActualNullAndMessage(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__HEX16_MESSAGE(110, expected, NULL, 3, "Custom Message.");
    VERIFY_FAILS_END
}
...
void testHEX16ArrayWithinDeltaSamePointer(void)
{
    ...
    TEST_ASSERT__WITHIN_ARRAY__HEX16(110, expected, expected, 3);
}
...
void testHEX16ArrayWithinDeltaSamePointerAndMessage(void)
{
    ...
    TEST_ASSERT__WITHIN_ARRAY__HEX16_MESSAGE(110, expected, expected, 3, "Custom Message.");
}
...
void testHEX8ArrayWithinDelta(void)
{
    ...
    TEST_ASSERT__WITHIN_ARRAY__HEX8(1, expected, actualSmallDelta, 3);
    TEST_ASSERT__WITHIN_ARRAY__HEX8(60, expected, actualBigDelta, 3);
}
...
void testHEX8ArrayWithinDeltaAndMessage(void)
{
    ...
    TEST_ASSERT__WITHIN_ARRAY__HEX8_MESSAGE(1, expected, actualSmallDelta, 3, "Custom Message.");
    TEST_ASSERT__WITHIN_ARRAY__HEX8_MESSAGE(60, expected, actualBigDelta, 3, "Custom Message.");
}
...
void testHEX8ArrayNotWithinDelta(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__HEX8(1, expected, actualBigDelta, 3);
    VERIFY_FAILS_END
}
...
void testHEX8ArrayNotWithinDeltaAndMessage(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__HEX8_MESSAGE(1, expected, actualBigDelta, 3, "Custom Message.");
    VERIFY_FAILS_END
}
...
void testHEX8ArrayWithinDeltaPointless(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__HEX8(60, expected, actualBigDelta, 0);
    VERIFY_FAILS_END
}
...
void testHEX8ArrayWithinDeltaPointlessAndMessage(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__HEX8_MESSAGE(60, expected, actualBigDelta, 0, "Custom Message.");
    VERIFY_FAILS_END
}
...
void testHEX8ArrayWithinDeltaExpectedNull(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__HEX8(60, NULL, actualBigDelta, 3);
    VERIFY_FAILS_END
}
...
void testHEX8ArrayWithinDeltaExpectedNullAndMessage(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__HEX8_MESSAGE(60, NULL, actualBigDelta, 3, "Custom Message.");
    VERIFY_FAILS_END
}
...
void testHEX8ArrayWithinDeltaActualNull(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__HEX8(60, expected, NULL, 3);
    VERIFY_FAILS_END
}
...
void testHEX8ArrayWithinDeltaActualNullAndMessage(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__WITHIN_ARRAY__HEX8_MESSAGE(60, expected, NULL, 3, "Custom Message.");
    VERIFY_FAILS_END
}
...
void testHEX8ArrayWithinDeltaSamePointer(void)
{
    ...
    TEST_ASSERT__WITHIN_ARRAY__HEX8(60, expected, expected, 3);
}
...
void testHEX8ArrayWithinDeltaSamePointerAndMessage(void)
{
    ...
    TEST_ASSERT__WITHIN_ARRAY__HEX8_MESSAGE(60, expected, expected, 3, "Custom Message.");
}
...
void testEqualIntArrays(void)
{
    ...
    TEST_ASSERT__EQUAL_ARRAY__INT(p0, p0, 1);
    TEST_ASSERT__EQUAL_ARRAY__INT(p0, p0, 4);
    TEST_ASSERT__EQUAL_ARRAY__INT(p0, p1, 4);
    TEST_ASSERT__EQUAL_ARRAY__INT(p0, p2, 3);
    TEST_ASSERT__EQUAL_ARRAY__INT(p0, p3, 1);
    TEST_ASSERT__EQUAL_ARRAY__INT(NULL, NULL, 1);
}
...
void testNotEqualIntArraysLengthZero(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__EQUAL_ARRAY__INT(p0, p1, 0);
    VERIFY_FAILS_END
}
...
void testEqualIntEachEqual(void)
{
    ...
    TEST_ASSERT__EQUAL_EACH__INT(1, p0, 1);
    TEST_ASSERT__EQUAL_EACH__INT(1, p0, 4);
    TEST_ASSERT__EQUAL_EACH__INT(987, p1, 4);
    TEST_ASSERT__EQUAL_EACH__INT(-2, p2, 3);
    TEST_ASSERT__EQUAL_EACH__INT(1, p3, 1);
}
...
void testNotEqualIntEachEqualNullActual(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__EQUAL_EACH__INT(1, p1, 4);
    VERIFY_FAILS_END
}
...
void testNotEqualIntEachEqual2(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__EQUAL_EACH__INT(-5, p0, 4);
    VERIFY_FAILS_END
}
...
void testNotEqualIntEachEqual3(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__EQUAL_EACH__INT(88, p0, 4);
    VERIFY_FAILS_END
}
...
void testNotEqualEachEqualLengthZero(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__EQUAL_EACH__INT(0, p0, 0);
    VERIFY_FAILS_END
}
...
void testEqualPtrArrays(void)
{
    ...
    TEST_ASSERT__EQUAL_ARRAY__PTR(p0, p0, 1);
    TEST_ASSERT__EQUAL_ARRAY__PTR(p0, p0, 3);
    TEST_ASSERT__EQUAL_ARRAY__PTR(p0, p1, 3);
    TEST_ASSERT__EQUAL_ARRAY__PTR(p1, p2, 2);
    TEST_ASSERT__EQUAL_ARRAY__PTR(p3, p0, 1);
}
...
void testNotEqualPtrArraysNullExpected(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__EQUAL_ARRAY__PTR(p0, p1, 2);
    VERIFY_FAILS_END
}
...
void testNotEqualPtrArraysNullActual(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__EQUAL_ARRAY__PTR(p1, p0, 2);
    VERIFY_FAILS_END
}
...
void testNotEqualPtrArrays1(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__EQUAL_ARRAY__PTR(p0, p1, 4);
    VERIFY_FAILS_END
}
...
void testEqualPtrEachEqual(void)
{
    ...
    TEST_ASSERT__EQUAL_EACH__PTR(&A, p0, 1);
    TEST_ASSERT__EQUAL_EACH__PTR(&A, p0, 3);
    TEST_ASSERT__EQUAL_EACH__PTR(&A, p1, 1);
    TEST_ASSERT__EQUAL_EACH__PTR(&B, p2, 2);
    TEST_ASSERT__EQUAL_EACH__PTR(&C, p3, 1);
}
...
void testNotEqualPtrEachEqualNullExpected(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__EQUAL_EACH__PTR(&A, p0, 2);
    VERIFY_FAILS_END
}
...
void testNotEqualPtrEachEqual1(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__EQUAL_EACH__PTR(&A, p0, 4);
    VERIFY_FAILS_END
}
...
void testNotEqualPtrEachEqual2(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__EQUAL_EACH__PTR(&B, p0, 4);
    VERIFY_FAILS_END
}
...
void testEqualInt8Arrays(void)
{
    ...
    TEST_ASSERT__EQUAL_ARRAY__INT8(p0, p0, 1);
    TEST_ASSERT__EQUAL_ARRAY__INT8(p0, p0, 4);
    TEST_ASSERT__EQUAL_ARRAY__INT8(p0, p1, 4);
    TEST_ASSERT__EQUAL_ARRAY__INT8(p0, p2, 3);
    TEST_ASSERT__EQUAL_ARRAY__INT8(p0, p3, 1);
}
...
void testEqualInt8EachEqual(void)
{
    ...
    TEST_ASSERT__EQUAL_EACH__INT8(1, p0, 1);
    TEST_ASSERT__EQUAL_EACH__INT8(1, p0, 4);
    TEST_ASSERT__EQUAL_EACH__INT8(117, p1, 3);
    TEST_ASSERT__EQUAL_EACH__INT8(-1, p2, 2);
    TEST_ASSERT__EQUAL_EACH__INT8(1, p3, 1);
}
...
void testNotEqualInt8EachEqual(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__EQUAL_EACH__INT8(1, p0, 2);
    VERIFY_FAILS_END
}
...
void testEqualCHARArrays(void)
{
    ...
    TEST_ASSERT__EQUAL_ARRAY__CHAR(p0, p0, 1);
    TEST_ASSERT__EQUAL_ARRAY__CHAR(p0, p0, 4);
    TEST_ASSERT__EQUAL_ARRAY__CHAR(p0, p1, 4);
    TEST_ASSERT__EQUAL_ARRAY__CHAR(p0, p2, 3);
    TEST_ASSERT__EQUAL_ARRAY__CHAR(p0, p3, 1);
}
...
void testEqualCHAREachEqual(void)
{
    ...
    TEST_ASSERT__EQUAL_EACH__CHAR(1, p0, 1);
    TEST_ASSERT__EQUAL_EACH__CHAR(1, p0, 4);
    TEST_ASSERT__EQUAL_EACH__CHAR(117, p1, 3);
    TEST_ASSERT__EQUAL_EACH__CHAR(-1, p2, 2);
    TEST_ASSERT__EQUAL_EACH__CHAR(1, p3, 1);
}
...
void testNotEqualCHAREachEqual(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__EQUAL_EACH__CHAR(1, p0, 2);
    VERIFY_FAILS_END
}
...
void testEqualUIntArrays(void)
{
    ...
    TEST_ASSERT__EQUAL_ARRAY__UINT(p0, p0, 1);
    TEST_ASSERT__EQUAL_ARRAY__UINT(p0, p0, 4);
    TEST_ASSERT__EQUAL_ARRAY__UINT(p0, p1, 4);
    TEST_ASSERT__EQUAL_ARRAY__UINT(p0, p2, 3);
    TEST_ASSERT__EQUAL_ARRAY__UINT(p0, p3, 1);
}
...
void testEqualUIntEachEqual(void)
{
    ...
    TEST_ASSERT__EQUAL_EACH__UINT(1, p0, 1);
    TEST_ASSERT__EQUAL_EACH__UINT(1, p0, 4);
    TEST_ASSERT__EQUAL_EACH__UINT(65132u, p1, 4);
    TEST_ASSERT__EQUAL_EACH__UINT(8, p2, 2);
    TEST_ASSERT__EQUAL_EACH__UINT(1, p3, 1);
}
...
void testNotEqualUIntEachEqual1(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__EQUAL_EACH__UINT(65132u, p0, 4);
    VERIFY_FAILS_END
}
...
void testNotEqualUIntEachEqual2(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__EQUAL_EACH__UINT(987, p0, 4);
    VERIFY_FAILS_END
}
...
void testEqualInt16Arrays(void)
{
    ...
    TEST_ASSERT__EQUAL_ARRAY__INT16(p0, p0, 1);
    TEST_ASSERT__EQUAL_ARRAY__INT16(p0, p0, 4);
    TEST_ASSERT__EQUAL_ARRAY__INT16(p0, p1, 4);
    TEST_ASSERT__EQUAL_ARRAY__INT16(p0, p2, 3);
    TEST_ASSERT__EQUAL_ARRAY__INT16(p0, p3, 1);
}
...
void testEqualInt16EachEqual(void)
{
    ...
    TEST_ASSERT__EQUAL_EACH__INT16(1, p0, 1);
    TEST_ASSERT__EQUAL_EACH__INT16(1, p0, 4);
    TEST_ASSERT__EQUAL_EACH__INT16(32111, p1, 3);
    TEST_ASSERT__EQUAL_EACH__INT16(-1, p2, 3);
    TEST_ASSERT__EQUAL_EACH__INT16(1, p3, 1);
}
...
void testNotEqualInt16EachEqual(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__EQUAL_EACH__INT16(127, p0, 4);
    VERIFY_FAILS_END
}
...
void testEqualInt32Arrays(void)
{
    ...
    TEST_ASSERT__EQUAL_ARRAY__INT32(p0, p0, 1);
    TEST_ASSERT__EQUAL_ARRAY__INT32(p0, p0, 4);
    TEST_ASSERT__EQUAL_ARRAY__INT32(p0, p1, 4);
    TEST_ASSERT__EQUAL_ARRAY__INT32(p0, p2, 3);
    TEST_ASSERT__EQUAL_ARRAY__INT32(p0, p3, 1);
}
...
void testEqualInt32EachEqual(void)
{
    ...
    TEST_ASSERT__EQUAL_EACH__INT32(8, p0, 1);
    TEST_ASSERT__EQUAL_EACH__INT32(8, p0, 4);
    TEST_ASSERT__EQUAL_EACH__INT32(65537, p1, 4);
    TEST_ASSERT__EQUAL_EACH__INT32(-3, p2, 3);
    TEST_ASSERT__EQUAL_EACH__INT32(1, p3, 1);
}
...
void testNotEqualInt32EachEqual(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__EQUAL_EACH__INT32(127, p0, 4);
    VERIFY_FAILS_END
}
...
void testEqualUINT8Arrays(void)
{
    ...
    TEST_ASSERT__EQUAL_ARRAY__UINT8(p0, p0, 1);
    TEST_ASSERT__EQUAL_ARRAY__UINT8(p0, p0, 4);
    TEST_ASSERT__EQUAL_ARRAY__UINT8(p0, p1, 4);
    TEST_ASSERT__EQUAL_ARRAY__UINT8(p0, p2, 3);
    TEST_ASSERT__EQUAL_ARRAY__UINT8(p0, p3, 1);
}
...
void testEqualUINT16Arrays(void)
{
    ...
    TEST_ASSERT__EQUAL_ARRAY__UINT16(p0, p0, 1);
    TEST_ASSERT__EQUAL_ARRAY__UINT16(p0, p0, 4);
    TEST_ASSERT__EQUAL_ARRAY__UINT16(p0, p1, 4);
    TEST_ASSERT__EQUAL_ARRAY__UINT16(p0, p2, 3);
    TEST_ASSERT__EQUAL_ARRAY__UINT16(p0, p3, 1);
}
...
void testEqualUINT32Arrays(void)
{
    ...
    TEST_ASSERT__EQUAL_ARRAY__UINT32(p0, p0, 1);
    TEST_ASSERT__EQUAL_ARRAY__UINT32(p0, p0, 4);
    TEST_ASSERT__EQUAL_ARRAY__UINT32(p0, p1, 4);
    TEST_ASSERT__EQUAL_ARRAY__UINT32(p0, p2, 3);
    TEST_ASSERT__EQUAL_ARRAY__UINT32(p0, p3, 1);
}
...
void testEqualHEXArrays(void)
{
    ...
    TEST_ASSERT__EQUAL_ARRAY__HEX(p0, p0, 1);
    TEST_ASSERT__EQUAL_ARRAY__HEX(p0, p0, 4);
    TEST_ASSERT__EQUAL_ARRAY__HEX(p0, p1, 4);
    TEST_ASSERT__EQUAL_ARRAY__HEX32(p0, p2, 3);
    TEST_ASSERT__EQUAL_ARRAY__HEX32(p0, p3, 1);
}
...
void testNotEqualHEXArrays1(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__EQUAL_ARRAY__HEX32(p0, p1, 4);
    VERIFY_FAILS_END
}
...
void testEqualHEX32Arrays(void)
{
    ...
    TEST_ASSERT__EQUAL_ARRAY__HEX32(p0, p0, 1);
    TEST_ASSERT__EQUAL_ARRAY__HEX32(p0, p0, 4);
    TEST_ASSERT__EQUAL_ARRAY__HEX32(p0, p1, 4);
    TEST_ASSERT__EQUAL_ARRAY__HEX32(p0, p2, 3);
    TEST_ASSERT__EQUAL_ARRAY__HEX32(p0, p3, 1);
}
...
void testEqualHEX16Arrays(void)
{
    ...
    TEST_ASSERT__EQUAL_ARRAY__HEX16(p0, p0, 1);
    TEST_ASSERT__EQUAL_ARRAY__HEX16(p0, p0, 4);
    TEST_ASSERT__EQUAL_ARRAY__HEX16(p0, p1, 4);
    TEST_ASSERT__EQUAL_ARRAY__HEX16(p0, p2, 3);
    TEST_ASSERT__EQUAL_ARRAY__HEX16(p0, p3, 1);
}
...
void testEqualHEX8Arrays(void)
{
    ...
    TEST_ASSERT__EQUAL_ARRAY__HEX8(p0, p0, 1);
    TEST_ASSERT__EQUAL_ARRAY__HEX8(p0, p0, 4);
    TEST_ASSERT__EQUAL_ARRAY__HEX8(p0, p1, 4);
    TEST_ASSERT__EQUAL_ARRAY__HEX8(p0, p2, 3);
    TEST_ASSERT__EQUAL_ARRAY__HEX8(p0, p3, 1);
}
...
void testEqualUINT8EachEqual(void)
{
    ...
    TEST_ASSERT__EQUAL_EACH__UINT8(127u, p0, 1);
    TEST_ASSERT__EQUAL_EACH__UINT8(127u, p0, 4);
    TEST_ASSERT__EQUAL_EACH__UINT8(1u, p1, 4);
    TEST_ASSERT__EQUAL_EACH__UINT8(128u, p2, 3);
    TEST_ASSERT__EQUAL_EACH__UINT8(1u, p3, 1);
}
...
void testNotEqualUINT8EachEqual2(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__EQUAL_EACH__UINT8(1, p0, 4);
    VERIFY_FAILS_END
}
...
void testNotEqualUINT8EachEqual3(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__EQUAL_EACH__UINT8(55u, p0, 4);
    VERIFY_FAILS_END
}
...
void testEqualUINT16EachEqual(void)
{
    ...
    TEST_ASSERT__EQUAL_EACH__UINT16(65132u, p0, 1);
    TEST_ASSERT__EQUAL_EACH__UINT16(65132u, p0, 4);
    TEST_ASSERT__EQUAL_EACH__UINT16(987, p1, 4);
    TEST_ASSERT__EQUAL_EACH__UINT16(1, p2, 3);
    TEST_ASSERT__EQUAL_EACH__UINT16(1, p3, 1);
}
...
void testEqualUINT32EachEqual(void)
{
    ...
    TEST_ASSERT__EQUAL_EACH__UINT32(65132u, p0, 1);
    TEST_ASSERT__EQUAL_EACH__UINT32(65132u, p0, 4);
    TEST_ASSERT__EQUAL_EACH__UINT32(987, p1, 4);
    TEST_ASSERT__EQUAL_EACH__UINT32(8, p2, 3);
    TEST_ASSERT__EQUAL_EACH__UINT32(1, p3, 1);
}
...
void testNotEqualUINT32EachEqual2(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__EQUAL_EACH__UINT32(987, p0, 4);
    VERIFY_FAILS_END
}
...
void testNotEqualUINT32EachEqual3(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__EQUAL_EACH__UINT32(1, p0, 4);
    VERIFY_FAILS_END
}
...
void testEqualHEXEachEqual(void)
{
    ...
    TEST_ASSERT__EQUAL_EACH__HEX(65132u, p0, 1);
    TEST_ASSERT__EQUAL_EACH__HEX(65132u, p0, 4);
    TEST_ASSERT__EQUAL_EACH__HEX(987, p1, 4);
    TEST_ASSERT__EQUAL_EACH__HEX(8, p2, 3);
    TEST_ASSERT__EQUAL_EACH__HEX(1, p3, 1);
}
...
void testNotEqualHEXEachEqual1(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__EQUAL_EACH__HEX32(65132u, p0, 4);
    VERIFY_FAILS_END
}
...
void testNotEqualHEXEachEqual2(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__EQUAL_EACH__HEX32(987, p0, 4);
    VERIFY_FAILS_END
}
...
void testNotEqualHEXEachEqual3(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__EQUAL_EACH__HEX(8, p0, 4);
    VERIFY_FAILS_END
}
...
void testEqualHEX32EachEqual(void)
{
    ...
    TEST_ASSERT__EQUAL_EACH__HEX32(65132u, p0, 1);
    TEST_ASSERT__EQUAL_EACH__HEX32(65132u, p0, 4);
    TEST_ASSERT__EQUAL_EACH__HEX32(987, p1, 4);
    TEST_ASSERT__EQUAL_EACH__HEX32(8, p2, 3);
    TEST_ASSERT__EQUAL_EACH__HEX32(1, p3, 1);
}
...
void testNotEqualHEX32EachEqual3(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__EQUAL_EACH__HEX32(8, p0, 4);
    VERIFY_FAILS_END
}
...
void testEqualHEX16EachEqual(void)
{
    ...
    TEST_ASSERT__EQUAL_EACH__HEX16(65132u, p0, 1);
    TEST_ASSERT__EQUAL_EACH__HEX16(65132u, p0, 4);
    TEST_ASSERT__EQUAL_EACH__HEX16(987, p1, 4);
    TEST_ASSERT__EQUAL_EACH__HEX16(8, p2, 3);
    TEST_ASSERT__EQUAL_EACH__HEX16(1, p3, 1);
}
...
void testNotEqualHEX16EachEqual2(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__EQUAL_EACH__HEX16(987, p0, 4);
    VERIFY_FAILS_END
}
...
void testNotEqualHEX16EachEqual3(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__EQUAL_EACH__HEX16(8, p0, 4);
    VERIFY_FAILS_END
}
...
void testEqualHEX8EachEqual(void)
{
    ...
    TEST_ASSERT__EQUAL_EACH__HEX8(254u, p0, 1);
    TEST_ASSERT__EQUAL_EACH__HEX8(254u, p0, 4);
    TEST_ASSERT__EQUAL_EACH__HEX8(123, p1, 4);
    TEST_ASSERT__EQUAL_EACH__HEX8(8, p2, 3);
    TEST_ASSERT__EQUAL_EACH__HEX8(1, p3, 1);
}
...
void testNotEqualHEX8EachEqual1(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__EQUAL_EACH__HEX8(253u, p0, 4);
    VERIFY_FAILS_END
}
...
void testNotEqualHEX8EachEqual3(void)
{
    ...
    EXPECT_ABORT_BEGIN
    TEST_ASSERT__EQUAL_EACH__HEX8(8, p0, 4);
    VERIFY_FAILS_END
}
...
void testEqualHEX64Arrays(void)
{
    ...
    TEST_ASSERT__EQUAL_ARRAY__HEX64(p0, p0, 1);
    TEST_ASSERT__EQUAL_ARRAY__HEX64(p0, p0, 4);
    TEST_ASSERT__EQUAL_ARRAY__HEX64(p0, p1, 4);
    TEST_ASSERT__EQUAL_ARRAY__HEX64(p0, p2, 3);
    TEST_ASSERT__EQUAL_ARRAY__HEX64(p0, p3, 1);
#endif
}
...
void testEqualUint64Arrays(void)
{
    ...
    TEST_ASSERT__EQUAL_ARRAY__UINT64(p0, p0, 1);
    TEST_ASSERT__EQUAL_ARRAY__UINT64(p0, p0, 4);
    TEST_ASSERT__EQUAL_ARRAY__UINT64(p0, p1, 4);
    TEST_ASSERT__EQUAL_ARRAY__UINT64(p0, p2, 3);
    TEST_ASSERT__EQUAL_ARRAY__UINT64(p0, p3, 1);
#endif
}
...
void testEqualInt64Arrays(void)
{
    ...
    TEST_ASSERT__EQUAL_ARRAY__INT64(p0, p0, 1);
    TEST_ASSERT__EQUAL_ARRAY__INT64(p0, p0, 4);
    TEST_ASSERT__EQUAL_ARRAY__INT64(p0, p1, 4);
    TEST_ASSERT__EQUAL_ARRAY__INT64(p0, p2, 3);
    TEST_ASSERT__EQUAL_ARRAY__INT64(p0, p3, 1);
#endif
}
