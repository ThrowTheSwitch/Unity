...
#else
const char PROGMEM UnityStrRanSuite[]                      = "RAN SUITE ";
...
{
    // No tests have run yet; this is the very first call to this function,
    // generated by one of our function macros that make tests be able to run
