...
/*-----------------------------------------------*/
#ifdef UNITY_USE_FILEMACRO_AS_TESTFILE
static const char* GetTestFilename(const char* filename)
{
    if(filename != NULL)
        return filename;

    return Unity.TestFile;
}
#else
static const char* GetTestFilename(const char* unused)
{
    (void)(unused);
    return Unity.TestFile;
}
...
/*-----------------------------------------------*/
static void UnityTestResultsFailBegin(const char* filename, const UNITY_LINE_TYPE line)
{
    UnityTestResultsBegin(filename, line);
...
void UnityConcludeTest(void)
{
    ...
    {
        UnityTestResultsBegin(NULL, Unity.CurrentTestLineNumber);
                               ...
                               const char* msg)
{
    ...
    if (expected == NULL)
    {
        UnityTestResultsFailBegin(filename, lineNumber);
                              ...
                              const UNITY_FLAGS_T flags)
{
    ...
    if (UnityIsOneArrayNull(expected, actual, filename, lineNumber, msg))
    {
        UNITY_FAIL_AND_BAIL;
    }
                                ...
                                const UNITY_FLAGS_T flags)
{
    ...
    if (UnityIsOneArrayNull((UNITY_INTERNAL_PTR)expected, (UNITY_INTERNAL_PTR)actual, filename, lineNumber, msg))
    {
        UNITY_FAIL_AND_BAIL;
    }
...
{
    UnityTestResultsBegin(GetTestFilename(filename), line);
    UnityPrint("INFO");
    if(format != NULL)
    {
        UnityPrint(": ");
...
/*-----------------------------------------------*/
void UnityFail(const char* msg, const char* filename, const UNITY_LINE_TYPE line)
{
    RETURN_IF_FAIL_OR_IGNORE;
...
/*-----------------------------------------------*/
void UnityIgnore(const char* msg, const char* filename, const UNITY_LINE_TYPE line)
{
    RETURN_IF_FAIL_OR_IGNORE;
...
/*-----------------------------------------------*/
void UnityMessage(const char* msg, const char* filename, const UNITY_LINE_TYPE line)
{
    UnityTestResultsBegin(filename, line);
    UnityPrint("INFO");
    if (msg != NULL)
