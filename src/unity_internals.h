...
typedef enum
{
	...
	UNITY_FLOAT_INVALID_TRAIT = UNITY_FLOAT_TRAIT__UNKNOWN,
...
#else	/* UNITY_SUPPORT_64 */
#define UNITY_TEST_ASSERT__NOT_EQUAL__INT64(threshold, actual, line, message)							UNITY_TEST_FAIL(																																																														(UNITY_LINE_TYPE)	(line),	UnityStrErr64)
#define UNITY_TEST_ASSERT__NOT_EQUAL__UINT64(threshold, actual, line, message)							UNITY_TEST_FAIL(																																																														(UNITY_LINE_TYPE)	(line),	UnityStrErr64)
#define UNITY_TEST_ASSERT__NOT_EQUAL__HEX64(threshold, actual, line, message)							UNITY_TEST_FAIL(																																																														(UNITY_LINE_TYPE)	(line),	UnityStrErr64)
#endif	/* UNITY_SUPPORT_64 */
